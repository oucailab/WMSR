...
def create_datasets(args):
    div2k = DIV2K(
        os.path.join(args.data_path, 'DIV2K/CS'), 
        os.path.join(args.data_path, 'DIV2K/LR'), 
    ...
    if 'Set5' in args.eval_sets:
        set5_hr_path = os.path.join(args.data_path, 'benchmark/Set5/CS')
        set5_lr_path = os.path.join(args.data_path, 'benchmark/Set5/LR')
    ...
    if 'Set14' in args.eval_sets:
        set14_hr_path = os.path.join(args.data_path, 'benchmark/Set14/CS')
        set14_lr_path = os.path.join(args.data_path, 'benchmark/Set14/LR')
    ...
    if 'B100' in args.eval_sets:
        b100_hr_path = os.path.join(args.data_path, 'benchmark/B100/CS')
        b100_lr_path = os.path.join(args.data_path, 'benchmark/B100/LR')
    ...
    if 'Urban100' in args.eval_sets:
        u100_hr_path = os.path.join(args.data_path, 'benchmark/Urban100/CS')
        u100_lr_path = os.path.join(args.data_path, 'benchmark/Urban100/LR')
    ...
    if 'Manga109' in args.eval_sets:
        manga_hr_path = os.path.join(args.data_path, 'benchmark/Manga109/CS')
        manga_lr_path = os.path.join(args.data_path, 'benchmark/Manga109/LR')
    ...
    if 'Oisst' in args.eval_sets:
        u100_hr_path = os.path.join(args.data_path, 'benchmark/Oisst/CS')
        u100_lr_path = os.path.join(args.data_path, 'benchmark/Oisst/LR')
        u100  = Benchmark(u100_hr_path, u100_lr_path, scale=args.scale, colors=args.colors)
        valid_dataloaders += [{'name': 'oisst', 'dataloader': DataLoader(dataset=u100, batch_size=1, shuffle=False)}]
    if 'Ghr' in args.eval_sets:
        manga_hr_path = os.path.join(args.data_path, 'benchmark/Ghr/CS')
        manga_lr_path = os.path.join(args.data_path, 'benchmark/Ghr/LR')
        manga = Benchmark(manga_hr_path, manga_lr_path, scale=args.scale, colors=args.colors)
        valid_dataloaders += [{'name': 'ghr', 'dataloader': DataLoader(dataset=manga, batch_size=1, shuffle=False)}]
